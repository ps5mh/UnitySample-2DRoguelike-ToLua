...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		L.BeginModule(null);
		GenericPropertyWrap.Register(L);
		LuaInterface_DebuggerWrap.Register(L);
		L.BeginModule("Game");
		SimpleTouchControllerWrap.Register(L);
		...
		L.EndModule();
		L.BeginModule("SimpleTouchController");
		L.RegFunction("TouchDelegate", SimpleTouchController_TouchDelegate);
		L.RegFunction("TouchStateDelegate", SimpleTouchController_TouchStateDelegate);
		L.EndModule();
		L.EndModule();
		L.BeginPreLoad();
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int SimpleTouchController_TouchDelegate(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(SimpleTouchController.TouchDelegate), func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(SimpleTouchController.TouchDelegate), func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int SimpleTouchController_TouchStateDelegate(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(SimpleTouchController.TouchStateDelegate), func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(SimpleTouchController.TouchStateDelegate), func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
